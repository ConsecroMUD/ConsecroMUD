	...
	throws SocketException, IOException
{
	...
	public static void main(String a[])
	{
		...
		String nameID="";
		String iniFile="consecromud.ini";
		if(a.length>0)
		{
		...
		try
		{
			while(true)
			{
				...
				System.out.println();
				System.out.println("CoonsecroMUD Off-Line");
				System.out.println("(C) 2009-2014 Bo Suscipio Solutions");
				System.out.println("http://www.consecromud.org");
