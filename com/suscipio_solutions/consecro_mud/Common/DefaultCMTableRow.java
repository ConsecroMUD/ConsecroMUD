...
public class DefaultCMTableRow implements CMTableRow
{
	@Override public String ID(){return "DefaultCMTableRow";}
	...
	@Override public CMObject newInstance(){try{return getClass().newInstance();}catch(final Exception e){return new DefaultCMTableRow();}}
	...
	public CMObject copyOf()
	{
		try
		{
			final DefaultCMTableRow CR=(DefaultCMTableRow)this.clone();
