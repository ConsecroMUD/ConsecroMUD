...
import com.suscipio_solutions.consecro_mud.core.collections.ConvertingIterator;
...
public class DefaultCMShop implements CMShop
{
	@Override public String ID(){return "DefaultCMShop";}
	...
	public CMObject copyOf()
	{
		try
		{
			...
			((DefaultCMShop)O).cloneFix(this);
			return (CMObject)O;
		}
		catch(final CloneNotSupportedException e)
		{
			return new DefaultCMShop();
		}
	}
	...
	@Override public CMObject newInstance(){try{return getClass().newInstance();}catch(final Exception e){return new DefaultCMShop();}}
	@Override public void initializeClass(){}

	public void cloneFix(DefaultCMShop E)
	{
	...
	public void buildShopFromXML(String text)
	{
		...
		if(shop==null)
		{
			Log.errOut("DefaultCMShop","Error getting base shopKeeper obj host from "+text);
			return;
		}
		...
		if(xmlV==null)
		{
			Log.errOut("DefaultCMShop","Error parsing data.");
			return;
		}
		...
		if(iV==null)
		{
			Log.errOut("DefaultCMShop","Error parsing 'INVS'.");
			return;
		}
		for(int i=0;i<iV.size();i++)
		{
			...
			{
				Log.errOut("DefaultCMShop","Error parsing 'INVS' data.");
				return;
			}
			...
			{
				Log.errOut("DefaultCMShop","Error parsing 'INV' data.");
				return;
			}
