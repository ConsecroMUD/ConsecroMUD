...
import com.suscipio_solutions.consecro_mud.Libraries.interfaces.ColorLibrary.ColorState;
...
public interface Session extends CMCommon, Modifiable, CMRunnable
{
	 ...
	 * indexed by consecromud color code.  May be from the standard list,
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#rawCharsOut(char[])
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#onlyPrint(String, boolean)
	 * @param msg the string to send to the user
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#rawPrintln(String)
	 * @param msg the string to send to the user
	 */
	 ...
	 * additional pre-linefeed if currently at
	 * the prompt.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#rawPrint(String)
	 * @param msg the string to send to the user
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#onlyPrint(String, boolean)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#promptPrint(String)
	 * @param msg the string to send to the user
	 */
	 ...
	 * on disconnnect.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String, long)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String, String, long)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String, String)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#prompt(String, long)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 ...
	 * disconnect.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#confirm(String, String, long)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 ...
	 * on disconnnect or time out.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#confirm(String, String)
	 * @param Message the prompt message to display to the user
	 * @param Default the default response if the user just hits enter
	 * @param maxTime max number of milliseconds to wait before timing out
	 * @return true if they entered Y, false otherwise
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#choose(String, String, String, long)
	 * @param Message the prompt message to display to the user
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#choose(String, String, String)
	 * @param Message the prompt message to display to the user
	 * @param Choices a list of uppercase characters that may be entered
	 * @param Default the default response if the user just hits enter
	 * @param maxTime max number of milliseconds to wait before timing out
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setBeingSnoopedBy(Session, boolean)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#isBeingSnoopedBy(Session)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#snoopSuspension(int)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#isStopped()
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#logout(boolean)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#isStopped()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setAfkFlag(boolean)
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setAFKMessage(String)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#isAfk()
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getAfkMessage()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setMob(MOB)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#mob()
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session.SessionStatus
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setLastPKFight()
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setLastNPCFight()
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getLastPKFight()
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getLastNPCFight()
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setInputLoopTime()
	 *
	 ...
	 * Is typically only held up by executing a user command, so it is an accurate
	 * gauge of a locked up user command.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getInputLoopTime()
	 */
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getServerTelnetMode(int)
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setServerTelnetMode(int, boolean)
	 * @param telnetCode the telnet code
	 *
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#getClientTelnetMode(int)
	 *
	 * @param telnetCode the telnet code
	 * @param onOff true to turn on, false to turn off the flag
	 */
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#TELNET_ANSI
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#setClientTelnetMode(int, boolean)
	 *
	 * @param telnetCode the telnet code
	 *
	 ...
	 *
	 * @see com.suscipio_solutions.consecro_mud.MOBS.interfaces.MOB#getAttributesBitmap()
	 * @see com.suscipio_solutions.consecro_mud.MOBS.interfaces.MOB.Attrib
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Session#changeTelnetMode(int, boolean)
