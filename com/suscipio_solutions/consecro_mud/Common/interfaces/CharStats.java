...
public interface CharStats extends CMCommon, Modifiable
{
   ...
   /**
	 ...
	 * @see com.suscipio_solutions.consecro_mud.CharClasses.interfaces.CharClass
	 ...
	 * @see com.suscipio_solutions.consecro_mud.CharClasses.interfaces.CharClass#getLevelCap()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Races.interfaces.Race#startRacing(MOB, boolean)
	 * @see com.suscipio_solutions.consecro_mud.Races.interfaces.Race
	 ...
	 * @see com.suscipio_solutions.consecro_mud.CharClasses.interfaces.CharClass
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.CharStats#displayClassName()
	 * @see #setDisplayClassName(String)
	 * @see #displayClassLevel(MOB, boolean)
	 * @param mob the mob whose class and overall level to display
	 * @return the name of this mobs current class.
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Races.interfaces.Race#AGE_DESCS
	...
	public class CODES
	{
		...
		public CODES()
		{
			...
			for(int i=0;i<addExtra.length+repExtra.length;i++)
			{
				...
				if(V.size()!=4)
				{
					Log.errOut("CharStats","Bad consecromud.ini charstat row, requires 4 ; separated entries: "+p);
					continue;
				}
				...
				if(replace)
				{
					...
					{
						Log.errOut("CharStats","Bad consecromud.ini charstat row, bad stat name: "+repStat);
						continue;
					}
				}
				...
				if(replace&&(oldStatCode>=0))
				{
					...
					Log.errOut("CharStats","Bad consecromud.ini charstat row, bad type: "+type);
			}
		}
