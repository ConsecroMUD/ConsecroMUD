...
public interface PlayerAccount extends CMCommon, AccountStats, Modifiable
{
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.PlayerAccount#setFlag(String, boolean)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.PlayerAccount#isSet(String)
	 * @param flagName the flag name
