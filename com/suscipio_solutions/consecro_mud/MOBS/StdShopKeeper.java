...
public class StdShopKeeper extends StdMOB implements ShopKeeper
{
	...
	protected CMShop shop=((CMShop)CMClass.getCommon("DefaultCMShop")).build(this);
	...
	protected void cloneFix(MOB E)
	{
		...
		if(E instanceof StdShopKeeper)
			shop=((CMShop)((StdShopKeeper)E).shop.copyOf()).build(this);
	}

	@Override public CMShop getShop(){return shop;}
