...
import com.suscipio_solutions.consecro_mud.WebMacros.grinder.GrinderItems.ItemDataField;
...
public class ItemData extends StdWebMacro
{
	...
	public String runMacro(HTTPRequest httpReq, String parm)
	{
		...
		&&(CMClass.getItem(newClassID)!=null))
		{
			...
			if(I instanceof ImmortalOnly) I=oldI;
		}
			...
			for(final ItemDataField o : ItemDataField.values())
			{
				...
				if(parms.containsKey(parmName))
				{
					...
					case WEIGHT: // weight
						...
						break;
					case ISMAP: // is map
						if(I instanceof com.suscipio_solutions.consecro_mud.Items.interfaces.RoomMap) return "true";
						return "false";
	...
	public static StringBuffer readableSpells(SpellHolder P, HTTPRequest httpReq, java.util.Map<String,String> parms, int borderSize)
	{
		...
		if(parms.containsKey("READABLESPELLS"))
		{
			...
			for(final Enumeration<Ability> a=CMClass.abilities();a.hasMoreElements();)
			{
				...
				||((A.classificationCode()&Ability.ALL_DOMAINS)==Ability.DOMAIN_IMMORTAL))
					continue;
