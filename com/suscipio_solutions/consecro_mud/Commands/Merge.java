...
public class Merge extends StdCommand
{
		...
		throws java.io.IOException
	{
		...
		if(firstWord.equalsIgnoreCase("DATABASE"))
		{
			...
			return doImmortalDBCompare(mob, scope, firstWord, commands);
		}
	...
	public boolean doImmortalDBCompare(MOB mob, String scope, String firstWord, Vector commands) throws java.io.IOException
	{
