...
public class Copy extends StdCommand
{
		...
		throws java.io.IOException
	{
		...
		for(int i=0;i<number;i++)
		{
			...
			if((E instanceof Item)&&((!(E instanceof ImmortalOnly))||(CMSecurity.isASysOp(mob)&&(CMProps.getVar(CMProps.Str.MUDNAME).toLowerCase().indexOf("consecromud")>=0))))
			{
		...
		if((E instanceof Item)&&(!(E instanceof ImmortalOnly))&&(room!=null))
