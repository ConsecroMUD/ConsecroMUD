		...
		throws java.io.IOException
	{
		...
		if(commandType.equals("QUEST"))
		{
			...
			if(commands.size()<3)
			{
				...
				{
					mob.tell(L("You must specify a valid quest string.  Try IMMHELP QUESTS."));
					return false;
				}
			}
			else
			{
				...
				{
					mob.tell(L("You must specify a VALID quest string.  This one contained errors.  Try IMMHELP QUESTS."));
					return false;
				}
				else
		...
		if(commandType.equals("CLAN"))
		{
			...
			if(commands.size()<3)
			{
				mob.tell(L("You must specify a valid clan name.  Try CLANLIST and IMMHELP CLANS."));
				return false;
			}
			else
			{
