...
public interface Area extends Economics, PhysicalAgent, Places
{
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#FLAG_THIN
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#THEME_FANTASY
	...
	/**
	 * Returns the consecromud .cmare filename that will be used when the EXPORT command
	 * is used in such a way as to auto-generate filenames.
	 * @return the name of the .cmare filename to use
	 */
	public String getArchivePath();
	/**
	 * Sets the consecromud .cmare filename that will be used when the EXPORT command
	 * is used in such a way as to auto-generate filenames.
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Climate
	 * @return a com.suscipio_solutions.consecro_mud.Common.interfaces.Climate object
	 */
	 ...
	 * current and future weather for this area.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.Climate
	 * @param obj a com.suscipio_solutions.consecro_mud.Common.interfaces.Climate object
	 */
	 ...
	 * areas.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.TimeClock
	 * @return a com.suscipio_solutions.consecro_mud.Common.interfaces.TimeClock object
	 */
	 ...
	 * areas.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.TimeClock
	 * @param obj a com.suscipio_solutions.consecro_mud.Common.interfaces.TimeClock object
	 */
	 ...
	 * shopkeepers, bankers, and other mobs.  See Immortal's Guide for the proper
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getBlurbFlag(String)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#addMetroRoom(Room)
	 * @see com.suscipio_solutions.consecro_mud.Locales.interfaces.Room
	 ...
	 * from parent areas.
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#delMetroRoom(Room)
	 * @see com.suscipio_solutions.consecro_mud.Locales.interfaces.Room
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getCompleteMap()
	 * @see com.suscipio_solutions.consecro_mud.Locales.interfaces.Room
	 ...
	 * add-ons.
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getProperMap()
	 * @see com.suscipio_solutions.consecro_mud.Locales.interfaces.Room
	 * @return an enumerator of Room objects
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.RoomnumberSet
	 * @return a com.suscipio_solutions.consecro_mud.Common.interfaces.RoomnumberSet object
	 */
	 ...
	 * those not yet loaded.
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.RoomnumberSet
	 * @param set a com.suscipio_solutions.consecro_mud.Common.interfaces.RoomnumberSet object
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area.State
	 * @param newState
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#delSubOp(String)
	 * @param username a players Name
	 */
	public void addSubOp(String username);
	/**
	 * Removes a SubOp to this area.
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#addSubOp(String)
	 * @param username a players Name
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getAreaIStats()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area.Stats
	...
	/**	Bitmap flag meaning that the object supports magic.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getTheme() */
	public final static int THEME_INHERIT=0;
	/**	Bitmap flag meaning that the object supports magic.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getTheme() */
	public final static int THEME_FANTASY=1;
	/**	Bitmap flag meaning that the object supports technology.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getTheme() */
	public final static int THEME_TECHNOLOGY=2;
	/**	Bitmap flag meaning that the object supports super powers.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getTheme() */
	public final static int THEME_HEROIC=4;
	/**	Bitmap flag meaning that the object only supports usage of above in Skills.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getTheme() */
	...
	/**	State flag meaning this area is a THIN type area.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_THIN=1;
	/**	State flag meaning this area is a INSTANCE parent type area.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_INSTANCE_PARENT=2;
	/**	State flag meaning this area is a INSTANCE child type area.  @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#flags() */
	public final static int FLAG_INSTANCE_CHILD=4;

	/** Various area IStat constants.. see @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getAreaIStats() */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Areas.interfaces.Area#getAreaState()
	 */
