package com.suscipio_solutions.consecro_mud.Races.interfaces;
...
public interface Race extends Tickable, StatsAffecting, MsgListener, CMObject, Modifiable
{
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Common.interfaces.CharState#getHitPoints()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Items.interfaces.Weapon
	 ...
	 * @see com.suscipio_solutions.consecro_mud.Abilities.interfaces.Ability
	 * @see com.suscipio_solutions.consecro_mud.Races.interfaces.Race#numRacialEffects(MOB)
	 * @param mob the mob to grant the abilities to
	 * @return a vector of the Ability objects
	 */
