...
public class Immortal_Multiwatch extends Immortal_Skill
{
	@Override public String ID() { return "Immortal_Multiwatch"; }
			...
			if((mob.session()!=null)&&(mob.session().getPreviousCMD()!=null))
			{
				...
				&&(!CMParms.combine(mob.session().getPreviousCMD(),0).equals(lastCommand)))
				{
					...
					for(int v=0;v<V.size();v++)
					{
						...
						final Immortal_Multiwatch A=(Immortal_Multiwatch)M.fetchEffect(ID());
						if(A!=null)
						{
