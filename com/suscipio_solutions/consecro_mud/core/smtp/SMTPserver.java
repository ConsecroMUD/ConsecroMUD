...
import com.suscipio_solutions.consecro_mud.core.threads.CMThreadFactory;
import com.suscipio_solutions.consecro_mud.core.threads.CMThreadPoolExecutor;
...
public class SMTPserver extends Thread implements Tickable
{
	...
	public static final String ServerVersionString = "ConsecroMUD SMTPserver/" + HOST_VERSION_MAJOR + "." + HOST_VERSION_MINOR;
	...
	private String 		domain="consecromud";
	...
	protected boolean initServer()
	{
		...
		{
			Log.errOut(getName(),"Set your consecromud.ini parameter: DOMAIN");
			return false;
		}
		if (page.getStr("PORT").length()==0)
		{
			Log.errOut(getName(),"Set your consecromud.ini parameter: PORT");
			return false;
		}
