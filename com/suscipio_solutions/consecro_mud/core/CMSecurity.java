...
public class CMSecurity
{
	...
	{
		ABILITIES, ABOVELAW, AFTER, IMMHELP, ALLSKILLS, ANNOUNCE, AS, AT, BAN, 
		...
		AREA_ABILITIES, AREA_ABOVELAW, AREA_AFTER, AREA_IMMHELP, AREA_ALLSKILLS, 
