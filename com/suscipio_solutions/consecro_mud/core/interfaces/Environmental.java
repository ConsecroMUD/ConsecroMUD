...
public interface Environmental extends Tickable, StatsAffecting, MsgListener, Contingent, Modifiable
{
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.interfaces.Environmental#text()
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.interfaces.Environmental#text()
	 * @see com.suscipio_solutions.consecro_mud.core.interfaces.Environmental#setMiscText(String)
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.interfaces.Environmental#setExpirationDate(long)
	 ...
	 * If this object expires, it should have a timestamp saying when it expires, in real time.
	 * When it expires, a MSG_EXPIRE message will be sent to it.
	 * @see com.suscipio_solutions.consecro_mud.core.interfaces.Environmental#expirationDate()
