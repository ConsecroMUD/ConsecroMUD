...
import com.suscipio_solutions.consecro_mud.core.CMSecurity.SecFlag;
...
import com.suscipio_solutions.consecro_mud.core.database.DBConnector.DBPreparedBatchEntry;
...
public class MOBloader
{
	...
	public void DBDelete(MOB mob, boolean deleteAssets)
	{
		...
		CMLib.coffeeTables().bump(mob,CMTableRow.STAT_PURGES);
