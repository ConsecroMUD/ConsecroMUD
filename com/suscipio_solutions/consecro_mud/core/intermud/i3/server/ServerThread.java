package com.suscipio_solutions.consecro_mud.core.intermud.i3.server;
...
import com.suscipio_solutions.consecro_mud.core.intermud.i3.net.ListenThread;
	...
	public void start()
	{
		...
		try
		{
			Intermud.setup(intermuds,
						   (PersistentPeer)Class.forName("com.suscipio_solutions.consecro_mud.core.intermud.i3.IMudPeer").newInstance());
		}
		catch( final Exception e )
		{
			Log.errOut("I3Server",e);
	...
	@Override public boolean tick(Tickable ticking, int tickID)
	{
		...
		{// Get new connections
			...
			for(i=0; i<5; i++)
			{
				...
				try
				{
					new_user = (ServerUser)copyObject("com.suscipio_solutions.consecro_mud.core.intermud.i3.IMudUser");
				}
