...
import com.suscipio_solutions.consecro_mud.Libraries.interfaces.ChannelsLibrary.CMChannel;
...
import com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.PersistenceException;
import com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.Persistent;
import com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.PersistentPeer;
import com.suscipio_solutions.consecro_mud.core.intermud.i3.server.I3Server;
/**
 * com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.Intermud
 ...
 * this object:
 * an implementation of com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices
 * an implementation of com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.PersistentPeer
 ...
 * @author George Reese
 * @version 1.0
 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices
 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.PersistentPeer
 */
...
public class Intermud implements Runnable, Persistent, Serializable
{
	 ...
	 * be a valid subclass of com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.Packet.
	 * This method will then route the packet to the
	 * currently running Intermud instance.
	 * @param p an instance of a subclass of com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.Packet
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.Packet
	 */
	 ...
	 * @param imud an instance of the mudlib implementation of com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices
	 * @param peer and instance of the mudlib implementation of com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.IntermudPeer
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.persist.PersistentPeer
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices#getLocalChannel
	 */
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices#getRemoteChannel
	 */
	...
	private synchronized void connect()
	{
		...
		try
		{
			if(name_servers.size()==0)
				Log.sysOut("Intermud3","No I3 routers defined in consecromud.ini file.");
			else
			{
				if(CMProps.getVar(CMProps.Str.ADMINEMAIL).indexOf('@')<0)
					Log.errOut("Intermud","Please set ADMINEMAIL in your consecromud.ini file.");
	 ...
	 * @see com.suscipio_solutions.consecro_mud.core.intermud.i3.packets.ImudServices#getChannels
	 */
