...
public class WandImmortal extends StdWand implements ImmortalOnly
{
	@Override public String ID(){    return "WandImmortal";}
	...
	public WandImmortal()
	{
		...
		secretIdentity="The Wand of the Immortals!";
