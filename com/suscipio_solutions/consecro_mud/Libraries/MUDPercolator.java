...
public class MUDPercolator extends StdLibrary implements AreaGenerationLibrary
{
	...
	{
		final String filePath="com/suscipio_solutions/consecro_mud/Libraries/layouts";
	...
	{
		List<ItemCraftor.ItemKeyPair> skillContents=(List<ItemCraftor.ItemKeyPair>)defined.get("____CONSECROMUD_"+skill.ID()+"_"+material+"_true");
		if(skillContents==null)
		{
			...
			if(skillContents==null)
				return null;
			defined.put("____CONSECROMUD_"+skill.ID()+"_"+material+"_true",skillContents);
		}
