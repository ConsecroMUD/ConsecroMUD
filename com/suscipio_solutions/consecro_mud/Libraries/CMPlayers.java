...
import com.suscipio_solutions.consecro_mud.core.collections.CrossRefTreeMap;
	...
	private boolean autoPurge()
	{
		...
		if(mask.hashCode() != this.autoPurgeHash)
		{
			...
			for(int i=0;i<presorted.length;i++)
			{
				...
				{
					Log.errOut("CMPlayers","Error in AUTOPURGE definition #"+(i+1)+" in consecromud.ini file! Fix immediately!!");
					continue;
				}
