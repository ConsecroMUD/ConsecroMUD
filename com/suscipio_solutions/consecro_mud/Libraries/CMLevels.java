...
public class CMLevels extends StdLibrary implements ExpLevelLibrary
{
	@Override public String ID(){return "CMLevels";}
	...
	public void level(MOB mob)
	{
		...
		if(mob.playerStats()!=null)
		{
			...
			if(mob.soulMate()==null)
				CMLib.coffeeTables().bump(mob,CMTableRow.STAT_LEVELSGAINED);
		}
