...
import com.suscipio_solutions.consecro_mud.Abilities.Common.CommonSkill;
...
import com.suscipio_solutions.consecro_mud.Common.interfaces.AbilityComponent.CompLocation;
...
import com.suscipio_solutions.consecro_mud.core.collections.FilteredIterator;
...
import com.suscipio_solutions.consecro_mud.core.collections.MultiIterator;
...
public class CMAble extends StdLibrary implements AbilityMapper
{
	...
	public void addClassAbility(String abilityID, Map<String, AbilityMapping> ableMap, AbilityMapping able)
	{
		...
		final int imm_level=getQualifyingLevel("Immortal",true,abilityID);
		if(((imm_level<0)||((qualLevel>=0)&&(qualLevel<imm_level)))
		&&(!able.ID.equalsIgnoreCase("Immortal"))
		&&(!able.ID.equalsIgnoreCase("All")))
			addCharAbilityMapping("Immortal",qualLevel,abilityID,true);
	}
	...
	public boolean getSecretSkill(String abilityID)
	{
		...
		for(final Enumeration e=CMClass.charClasses();e.hasMoreElements();)
		{
			...
			if(completeAbleMap.containsKey(charClass)&&(!charClass.equals("Immortal")))
			{
				final Map<String,AbilityMapping> ableMap=completeAbleMap.get(charClass);
				if(ableMap.containsKey(abilityID))
				{
