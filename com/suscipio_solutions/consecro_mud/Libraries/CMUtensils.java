...
import com.suscipio_solutions.consecro_mud.core.collections.TriadVector;
...
public class CMUtensils extends StdLibrary implements CMMiscUtils
{
	@Override public String ID(){return "CMUtensils";}
			...
			if(R!=null)
			{
				...
				if(newLastTickedDateTime==0)
				{
					...
					if(mob instanceof ShopKeeper)
					{
						...
						final CMShop shop = ((ShopKeeper)mob).getShop();
